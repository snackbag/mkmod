...
func main() {
	...
	Mkmod(result[*platform].(map[string]interface{})[*version].(map[string]interface{})["instructions"].([]interface{}), ModContext{*platform, *name, *version, id, packageName, mainName})
}
